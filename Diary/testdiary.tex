...
\\
These tests were written to test the functionality of matrix rank with various simple inputs. 
...
\\
These tests were written to test matrix determinants with various simple inputs. 
